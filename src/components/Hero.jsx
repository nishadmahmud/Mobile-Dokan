  ...
  return (
    <div className="mt-16 mb-10">
      ...
      <div className="text-center space-y-4">
        <h2 className="text-7xl font-light">Browse, Search, View, Buy</h2>
        <p className="opacity-80 w-[50%] mx-auto">
          Best place to browse, search, view details and purchase of top
          flagship phones of the current time - Mobile Dokan
        </p>
        <Form
          onSubmit={(e) => {
          ...
          className="flex flex-col md:flex-row justify-center items-center gap-3 w-[60%] m-auto"
        >
          <input
            value={searchText}
            ...
            className="bg-white border border-gray-300 rounded-sm py-3 px-4 w-full shadow-sm focus:outline-none focus:shadow-outline"
          />
          <button
            type="submit"
